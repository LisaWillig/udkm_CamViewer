...
class Fluence:
    ...
    def calculateWaveplateAngle(self, P_c):
        ...
        try:
            calibration = \
                np.genfromtxt('..\Calibration_PowerWaveplate\Calibration\\'
                              '\Calibration_PowervsWaveplateAngle.txt')
        except OSError:
    ...
    def calculateFluenceFromPower(self, power, anglePump, repitionRate,FWHMx, FWHMy):
        """
    ...
    def setFWHMFromLive(self, FWHMx, FWHMy):
        """
        Read fitted FWHM values from Textfile with Pumpentries
        :return: FWHMx, FWHMy in µm
        """
